...
@Getter
@Setter
@JsonFilter("tradesuitePtaFilter")
public class TradesuitePta{
    ...
    @JoinColumn(name = "INSTID", referencedColumnName = "ORG_ID", nullable = false)
    @OnDelete(action = OnDeleteAction.CASCADE)
    private Organization inst;
...
//    private String ctmDetailRefId;
    ...
    @JoinColumns({
            @JoinColumn(name="ctm_block_ref_id", referencedColumnName="TRADE_SIDE_ID"),
            @JoinColumn(name="ctm_detail_ref_id", referencedColumnName="TRADE_DETAIL_ID")
    })
    //@JsonIgnore
